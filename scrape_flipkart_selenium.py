"""
Run Flipkart scraper with Selenium (more reliable)
"""
...
def main():
    print("\n" + "=" * 70)
    print("FLIPKART LAPTOP SCRAPER (SELENIUM)")
    print("=" * 70)
    ...
    # Scrape
    df = scrape_flipkart_selenium(query, max_products=max_products, save_csv=True, headless=headless)
    ...
    if not df.empty:
        ...
        print("\n" + "=" * 70)
        print("✅ Check flipkart.csv for complete data!")
        print("=" * 70)
    else:
